  ...
  persist(
    (set, get) => ({
      ...
      updatePassword: (currentPassword: string, newPassword: string) => {
        ...
        console.log('updatePassword called for user:', currentUser);
        console.log('current userPasswords state:', state.userPasswords);
        
        if (!currentUser) {
          console.log('No current user, failing');
          return false;
        }
        ...
        console.log('customPassword:', customPassword);
        console.log('defaultPassword:', defaultPassword);
        console.log('actualCurrentPassword:', actualCurrentPassword);
        console.log('provided currentPassword:', currentPassword);
        
        if (currentPassword !== actualCurrentPassword) {
          console.log('Password mismatch, failing');
          return false;
        }
        
        // Update password
        const newUserPasswords = {
          ...state.userPasswords,
          [currentUser]: newPassword
        };
        
        console.log('Setting new userPasswords:', newUserPasswords);
